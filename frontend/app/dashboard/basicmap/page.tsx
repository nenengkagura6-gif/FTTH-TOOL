    ...
    <ToolPage
      ...
      guide={{
        ...
        steps: [
          ...
          "Jalan yang tidak ada di OpenStreetMap tidak punya nama. Isi kolom 'nama_dipakai' di file _jalan.csv, lalu proses ulang KML yang sama supaya namanya ikut tergambar.",
        ],
        output:
