...
export default function PricingPage({ params }: PageProps) {
  ...
  const plans = [
    {
      ...
      features: [
        ...
        { label: locale === "en" ? "Fiber Color Code Calculator" : "Kalkulator Kode Warna Fiber", included: true },
        { label: locale === "en" ? "OPM Loss & OTDR Fault Locator" : "Kalkulator OPM & OTDR Fault Locator", included: true },
        { label: locale === "en" ? "Standard processing speed" : "Kecepatan pemrosesan standar", included: true },
        { label: locale === "en" ? "Basic KML & CAD format tools" : "Alat dasar format KML & CAD", included: false },
        { label: locale === "en" ? "Splice Manager & KML BOQ" : "Splice Manager & KML BOQ", included: false },
        { label: locale === "en" ? "API Access & Integration" : "Akses & Integrasi API", included: false },
      ],
    ...
    },
    {
      ...
      description: locale === "en" ? "For individuals who only need basic tools with unlimited processing." : "Untuk individu yang hanya memerlukan alat dasar dengan pemrosesan tanpa batas.",
      features: [
        { label: locale === "en" ? "Unlimited KML Duplicate Checker" : "Pendeteksi Duplikat KML Tanpa Batas", included: true },
        { label: locale === "en" ? "Format converters (KML/CSV/DXF/SHP)" : "Konverter format (KML/CSV/DXF/SHP)", included: true },
        { label: locale === "en" ? "Unlimited file size uploads" : "Bebas batasan ukuran berkas", included: true },
        { label: locale === "en" ? "Standard processing queue" : "Antrean pemrosesan standar", included: true },
        { label: locale === "en" ? "Splice Manager & KML BOQ" : "Splice Manager & KML BOQ", included: false },
        { label: locale === "en" ? "OTDR Trace Analyzer" : "Penganalisis Trace OTDR", included: false },
        { label: locale === "en" ? "API Access & Integration" : "Akses & Integrasi API", included: false },
      ],
    ...
    },
    {
      ...
      features: [
        ...
        { label: locale === "en" ? "Splice Manager & KML BOQ Generator" : "Splice Manager & Pembuat KML BOQ", included: true },
        { label: locale === "en" ? "KML Extractor & Database HP tools" : "Ekstraktor KML & Alat Database HP", included: true },
        { label: locale === "en" ? "API Access & developer keys" : "Akses API & kunci developer", included: true },
        { label: locale === "en" ? "Super fast priority queue" : "Antrean prioritas super cepat", included: true },
        { label: locale === "en" ? "Priority email support (24h SLA)" : "Dukungan email prioritas (SLA 24j)", included: true },
      ],
  ...
  const compare = [
    { label: locale === "en" ? "Files per month" : "File per bulan", free: "50", basic: locale === "en" ? "Unlimited" : "Tanpa Batas", pro: locale === "en" ? "Unlimited" : "Tanpa Batas" },
    { label: locale === "en" ? "Core Utilities (Color Code/OPM)" : "Utilitas Inti (Color Code/OPM)", free: true, basic: true, pro: true },
    { label: locale === "en" ? "KML Checker & Converters" : "KML Checker & Konverter", free: false, basic: true, pro: true },
    { label: locale === "en" ? "OTDR Trace & Splice Manager" : "OTDR Trace & Splice Manager", free: false, basic: false, pro: true },
    { label: locale === "en" ? "Queue priority" : "Prioritas antrean", free: locale === "en" ? "Standard" : "Standar", basic: locale === "en" ? "Standard" : "Standar", pro: locale === "en" ? "Priority" : "Prioritas" },
    { label: locale === "en" ? "Premium tools" : "Alat premium", free: false, basic: false, pro: true },
    { label: locale === "en" ? "API access" : "Akses API", free: false, basic: false, pro: true },
